    ...
    <section style="background-color: rgb(251, 251, 251); height: auto;" id="03search">
        ...
        <div id="product-display">
            ...
            <ul id="all-products" class="product-list active">
                ...
                <li style="background-color: rgb(234, 255, 127);"><a href="./page-p01-productname.html" tabindex="0">商品020用途</li>
                <li style="background-color: rgb(234, 255, 127);"><a href="./page-p01-productname.html" tabindex="0">商品021用途</li>
                <li><a href="./page-p01-productname.html" tabindex="0"></a>商品022</li>
                <li style="background-color: rgb(234, 255, 127);"><a href="./page-p01-productname.html" tabindex="0">商品023用途</li>
            </ul>

            <!-- 処理材料リスト -->
            <ul id="material-products" class="product-list">
                <li style="background-color: aquamarine;"><a href="./page-p01-productname.html" tabindex="0">商品012処理</li>
                <li style="background-color: aquamarine;"><a href="./page-p01-productname.html" tabindex="0">商品015処理</li>
            </ul>
